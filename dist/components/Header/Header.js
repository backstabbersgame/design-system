...
export const Header = ({ links, activeLink, onLogoClick, onMenuClick, onLinkClick, onAccountClick, }) => {
    ...
    return (React.createElement(BasicHeader, { className: styles.header },
        React.createElement(Image, { width: isMobile ? 116 : 145, height: isMobile ? 32 : 40, src: `${basePath}/images/aalors - horizontal - light.svg`, alt: 'Solara Studios Logo with light colors', onClick: handleLogoClick, style: { cursor: 'pointer' } }),
